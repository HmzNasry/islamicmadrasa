...
function changeLanguage(language, events = [toggleMenue(), loadScreen]) {
    ...
    const languageData = {
        ...
        fa: {
            ...
            "register-description": "لطفا از دکمه زیر برای دسترسی به فرم ثبت نام استفاده کنید<br>دانش آموزان بر اساس سن و دانش خود به 3 کلاس تقسیم می شوند:<br> صنف 1 / صنف 2 /صنف 3 <br>بر اساس سن و دانش خود",
        ...
        ps: {
            ...
            "register-description": "مهرباني وکړئ د نوم لیکنې فورمې ته د لاسرسي لپاره لاندې تڼۍ وکاروئ<br>زده کونکي په 3 ټولګیو ویشل شوي دي:<br> د دوی د عمر او پوهې پراساس 1 ټولګي / 2 ټولګي / ۳ ټولګي <br>",
